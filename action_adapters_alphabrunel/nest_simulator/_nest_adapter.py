...
class NESTAdapter:
    ...
    def __configure_nest(self, simulator):
        ...
        #
        # Spike recorder, record to 'ascii'.
        #
        espikes = simulator.Create(self.__sci_params.spike_recorder_device, params={
            ...
            # "record_to":self.__sci_params.excitatory_spikes_model['record_to']            // 'ascii'
        })
        ispikes = simulator.Create(self.__sci_params.spike_recorder_device, params={
            ...
            # "record_to":self.__sci_params.inhibitory_spikes_model['record_to']            // 'ascii'
        })
